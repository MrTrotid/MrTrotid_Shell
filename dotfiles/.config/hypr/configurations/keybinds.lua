...
hl.bind(mainMod .. " + ALT + RETURN", hl.dsp.exec_cmd("paplay --volume=32768 '~/.config/hypr/config_Kitty-Efeckt_rezero_death.mp3' & ghostty"))
...
hl.bind(mainMod .. " + SHIFT + E", hl.dsp.exec_cmd("pkill rofi || rofimoji || rofi -show emoji -modi emoji"))  --action copy"))
...
hl.bind("ALT + PRINT", hl.dsp.exec_cmd('grim -g "$(slurp)" "$HOME/Pictures/screenshot_$(date +\'%Y-%m-%d_%H-%M-%S\')).png && notify-send "📸 Screenshot saved!" "Area captured"'))
