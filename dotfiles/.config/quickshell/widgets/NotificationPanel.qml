...
Item {
    ...
    readonly property color _base: "#0f1110"
    readonly property color _mantle: "#0a0b0a"
    readonly property color _crust: "#060706"
    property color _surface: "#131514"
    property color _surfaceVar: "#1c1e1d"
    property color _surfaceHigh: "#242725"
    property color _onSurface: "#c5cbc9"
    property color _onSurfaceVar: "#757d7b"
    property color _outline: "#2e3331"
