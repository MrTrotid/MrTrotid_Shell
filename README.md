...
| BrightnessService | Brightness polling (5s) + control |
| VolumeService | Volume polling (3s) + control |
| NetworkService | nmcli monitoring |
| BatteryService | UPower + sysfs, hasBattery guard |
| SystemService | CPU + memory from /proc (2s poll) |
| NotificationService | DBus notification server, grouped notifications, toast list |
